...
```{r creating individuals, echo=T, tidy=T}
...
```{r simulation of movement, echo=F}
...
#ggplot(coordin3, aes(x = x, y = y, col = state, label = individual)) + geom_point(size = 10) +
#  scale_color_manual(values = c("#56B4E9","#D55E00")) + 
#  ggrepel::geom_text_repel(data = coordin3, aes(label = individual), size = 5, point.padding = 15, min.segment.length = 0,
#                           fontface = "bold", show.legend = T) +
#  theme + xlab("") + ylab("") + ggtitle("Health state of individuals after travel") +
#  guides(colour = guide_legend(title = "Health state", override.aes = list(size = 5)))
...
#ggplot(coordin4, aes(x = x, y = y, col = state, label = individual)) + geom_point(size = 10) +
#  scale_color_manual(values = c("#56B4E9","#D55E00")) + 
#  ggrepel::geom_text_repel(data = coordin4, aes(label = individual), size = 5, point.padding = 15, min.segment.length = 0,
#                           fontface = "bold", show.legend = T) +
